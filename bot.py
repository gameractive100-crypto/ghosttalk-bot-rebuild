...
import time, secrets
import threading  # ✅ NEW: Keep-alive ke liye
...
# ✅✅✅ NEW: KEEP-ALIVE PINGER SYSTEM ✅✅✅
def keep_alive_pinger():
    """
    Render free tier ko awake rakhne ke liye self-ping system
    Har 10 minutes mein ADMIN ko ek message bhejta hai
    """
    PING_INTERVAL = 600  # 10 minutes (seconds)

    def ping_loop():
        time.sleep(60)  # Initial 1 minute wait (bot start hone do)
    ...
    thread.start()
    logger.info("🔄 Keep-alive pinger started (every 10 minutes)")
